...
extra:
представь рекурсивные вызовы оператором goto. те происходит переходы по строчкам внутри рекурсивной функции + мутация переменных из вне - которые нам и нужны.

[💎](https://github.com/ru51a4/arithmetic-expression-cpp/blob/main/main.cpp)  
